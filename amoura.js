...
/*
let review;
document.getElementById("review-submit-btn").onclick = function(){
  review = document.getElementById("notess").value;
  document.getElementById("review-input").textContent = review;
  console.log(review)
};
*/